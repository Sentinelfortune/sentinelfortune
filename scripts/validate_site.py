...
def main():
    ...
    # A real placeholder is REPLACE_WITH_<NAME>. The bare prefix appears
    # legitimately in the code that DETECTS an unconfigured storefront, so
    # matching on it alone flags the guard as the thing it guards against.
    check(not re.search(r"REPLACE_WITH_[A-Z]", home),
          "index.html: no unresolved placeholders",
