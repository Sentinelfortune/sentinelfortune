...
| No public directory listing | ✅ Implemented | `SHOP_DOWNLOADS_BUCKET` is never given public bucket access (documented requirement in `CLOUDFLARE_SHOP_SETUP.md` §2); all reads are token-gated through the Worker |
